    ...
    <div class="container-fluid">
      <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
          <div class="card">
            <div class="header">
              <h2>NIVELES GUARDADOS EN LA BASE DE DATOS</h2>
            </div>
            <div class="body">
                 ...
                 while($fila = $query->fetch_array()){
                  ...
                  <tr>
                   ...
                   <td style="text-align: center; width: 200px;" >
                    <a onclick="eliminar(<?php echo $fila['id_nivel']?>)"><button type="button" class="btn bg-red btn-xs waves-effect" style="border-radius: 100px;">
                      <i class="material-icons">delete_forever</i>
                    </button> </a>
                    &nbsp; &nbsp; &nbsp;
                    <?php echo "<a href='up_nivel.php?id_nivel=".$fila['id_nivel']."'> <button type='button' class='btn bg-light-green btn-xs waves-effect' style='border-radius: 100px;'>
...
<script type="text/javascript">
  function eliminar(id_nivel) {
    ...
    .then((OK) => {
      if (OK) {
        $.ajax({
         url:"../../delete/eliminar_nivel.php?del=" + id_nivel,
