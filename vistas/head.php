...
<nav class="mt-2">
 <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
   <li class="nav-item">
     ...
     <li class="nav-item">
     <a href="frente.php" class="nav-link">
        <i class="fas fa-paste"></i>
          <p> &nbsp; Frente</p>
     </a>
   </li>
   <li class="nav-item">
       <a href="zona.php" class="nav-link">
        <i class="fas fa-paste"></i>
          <p> &nbsp; Zona</p>
     </a>
   </li>
   <li class="nav-item">
       <a href="centro.php" class="nav-link">
        <i class="fas fa-paste"></i>
          <p> &nbsp; Centro de trabajo</p>
     </a>
   </li>
   <li class="nav-item">
       <a href="organismo.php" class="nav-link">
        <i class="fas fa-user-friends"></i>
        <p> &nbsp; Organismo</p>
     </a>
   </li>
   <li class="nav-item">
       <a href="miembro.php" class="nav-link">
   ...
   <li class="nav-item">
       <a href="captura.php" class="nav-link">
