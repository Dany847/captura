                 ...
                 while($fila = $query->fetch_array()){
                  ...
                  <tr>
                   ...
                   <td style="text-align: center; width: 200px;" >
                    <a onclick="eliminar(<?php echo $fila['id_zona']?>)"><button type="button" class="btn bg-red btn-xs waves-effect" style="border-radius: 100px;">
                      <i class="material-icons">delete_forever</i>
                    </button></a>

                    &nbsp; &nbsp; &nbsp;
                    <?php echo "<a href='up_zona.php?id_zona=".$fila['id_zona']."'> <button type='button' class='btn bg-light-green btn-xs waves-effect' style='border-radius: 100px;'>
